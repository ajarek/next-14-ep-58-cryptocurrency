...
export function BarChartEthereum({description, info1, info2}:{description:string, info1:string, info2:string}) {
  return (
      ...
      <CardContent>
        <ChartContainer config={chartConfig}>
          <BarChart accessibilityLayer data={chartData}>
            ...
            />
            <Bar dataKey="ethereum" fill="var(--color-ethereum)" radius={4} barSize={32} />
          </BarChart>
        </ChartContainer>
      </CardContent>
