...
const InfoCryptocurrency = ({text1, text2, text3, text4}:{text1:string, text2:string, text3:string, text4:string}) => {
  return (
          ...
          {crypto
            ...
            .map((cr) => (
              ...
              >
                ...
                <div className={cr.price_change_24h / cr.current_price>=0?'text-green-500':'text-red-500'}>
